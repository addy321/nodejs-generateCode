...
namespace Coldairarrow.IBusiness.Video
{
    public interface IAdvertisingBusiness
    {
        ...
        /// <returns></returns>
        Task<List<Advertising>> GetDataList(PageInput<Advertising> input, string CompanyStyle);
        /// <summary>
        /// 获取详情
        /// </summary>
        /// <param name="Id">主键</param>
        /// <returns></returns>
        Task<Advertising> GetTheData(int Id);
        ...
        /// <returns></returns>
        Task InsertData(Advertising entity);
        ...
        /// <returns></returns>
        Task UpdateData(Advertising entity);
